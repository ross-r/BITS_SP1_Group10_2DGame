...
public class Constants {
	...
	public static final float	PLAYER_MOVE_SPEED = 8.F;
	public static final float	PLAYER_MOVE_SPEED_MULTIPLIER = 3.0F; // ( PLAYER_MOVE_SPEED * x )
	public static final float	PLAYER_JUMP_SPEED_MULTIPLIER = 0.75F; // ( PLAYER_MOVE_SPEED * x )
