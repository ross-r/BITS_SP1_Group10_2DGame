...
public class ObjectFridge02 extends Platform {
	...
	public ObjectFridge02(int x, int y) {
		super();

		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);

		this.type = PLATFORM_TYPE.OBJECT_FRIDGE02;

		this.texture = TextureManager.get("Object_Fridge02.png");
