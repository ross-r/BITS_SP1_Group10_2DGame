...
public class SingleGroundPlatformMid extends Platform {
	...
	public SingleGroundPlatformMid(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_PLATFORM_MID;
		
		this.texture = TextureManager.get("Ground_Platform_Mid.png");
