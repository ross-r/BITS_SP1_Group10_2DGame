...
public class SingleGroundRoofMid extends Platform {
	...
	public SingleGroundRoofMid(int x, int y) {
		super();

		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);

		this.type = PLATFORM_TYPE.GROUND_ROOF_MID;

		this.texture = TextureManager.get("Ground_Roof_Mid.png");
