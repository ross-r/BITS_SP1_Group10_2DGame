...
public class SingleGroundBottomRightSpikesConnect extends Platform {
	...
	public SingleGroundBottomRightSpikesConnect(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_BOTTOM_RIGHT_SPIKESCONNECT;
		
		this.texture = new Texture(Graphics.nvgHandle(), "Ground_Bottom_Right_SpikesConnect.png");
