...
public class SingleGroundTopRight extends Platform {
	...
	public SingleGroundTopRight(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_TOP_RIGHT;
		
		this.texture = new Texture(Graphics.nvgHandle(), "Ground_Top_Right.png");
