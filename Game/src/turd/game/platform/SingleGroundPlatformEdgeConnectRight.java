...
public class SingleGroundPlatformEdgeConnectRight extends Platform {
	...
	public SingleGroundPlatformEdgeConnectRight(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_PLATFORM_EDGE_CONNECT_RIGHT;
		
		this.texture = TextureManager.get("Ground_Platform_EdgeConnect_Right.png");
