...
public class SingleGroundPlatformEdgeConnectLeft extends Platform {
	...
	public SingleGroundPlatformEdgeConnectLeft(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_PLATFORM_EDGE_CONNECT_LEFT;
		
		this.texture = TextureManager.get("Ground_Platform_EdgeConnect_Left.png");
