...
public class SingleGroundBottomFarRight extends Platform {
	...
	public SingleGroundBottomFarRight(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_BOTTOM_FARRIGHT;
		
		this.texture = new Texture(Graphics.nvgHandle(), "Ground_Bottom_FarRight.png");
