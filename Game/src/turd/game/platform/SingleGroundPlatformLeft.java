...
public class SingleGroundPlatformLeft extends Platform {
	...
	public SingleGroundPlatformLeft(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_PLATFORM_LEFT;
		
		this.texture = TextureManager.get("Ground_Platform_Left.png");
