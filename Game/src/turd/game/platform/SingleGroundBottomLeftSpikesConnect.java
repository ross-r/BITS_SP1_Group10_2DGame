...
public class SingleGroundBottomLeftSpikesConnect extends Platform {
	...
	public SingleGroundBottomLeftSpikesConnect(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_BOTTOM_LEFT_SPIKESCONNECT;
		
		this.texture = new Texture(Graphics.nvgHandle(), "Ground_Bottom_Left_SpikesConnect.png");
