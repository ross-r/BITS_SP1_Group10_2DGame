...
public class SingleGroundMidRight extends Platform {
	...
	public SingleGroundMidRight(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_MID_RIGHT;
		
		this.texture = new Texture(Graphics.nvgHandle(), "Ground_Mid_Right.png");
