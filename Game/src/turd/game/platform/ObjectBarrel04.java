...
public class ObjectBarrel04 extends Platform {
	...
	public ObjectBarrel04(int x, int y) {
		super();

		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);

		this.type = PLATFORM_TYPE.OBJECT_BARREL04;

		this.texture = TextureManager.get("Object_Barrel04.png");
