...
public class SingleGroundRoofRight extends Platform {
	...
	public SingleGroundRoofRight(int x, int y) {
		super();

		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);

		this.type = PLATFORM_TYPE.GROUND_ROOF_RIGHT;

		this.texture = TextureManager.get("Ground_Roof_Right.png");
