...
public class ObjectBarrel03 extends Platform {
	...
	public ObjectBarrel03(int x, int y) {
		super();

		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);

		this.type = PLATFORM_TYPE.OBJECT_BARREL03;

		this.texture = TextureManager.get("Object_Barrel03.png");
