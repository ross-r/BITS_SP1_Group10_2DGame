...
public class ObjectBarrel01 extends Platform {

	private static final int PLATFORM_WIDTH = 90;
	private static final int PLATFORM_HEIGHT = 100;

	private Texture texture;

	public ObjectBarrel01(int x, int y) {
		super();

		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);

		this.type = PLATFORM_TYPE.OBJECT_BARREL01;

		this.texture = TextureManager.get("Object_Barrel01.png");
