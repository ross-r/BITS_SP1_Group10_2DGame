...
public class ObjectFridge01 extends Platform {

	private static final int PLATFORM_WIDTH = 180;
	private static final int PLATFORM_HEIGHT = 180;

	private Texture texture;

	public ObjectFridge01(int x, int y) {
		super();

		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);

		this.type = PLATFORM_TYPE.OBJECT_FRIDGE01;

		this.texture = TextureManager.get("Object_Fridge01.png");
