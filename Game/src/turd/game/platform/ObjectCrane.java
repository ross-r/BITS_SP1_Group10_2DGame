...
public class ObjectCrane extends Platform {

	private static final int PLATFORM_WIDTH = 500;
	private static final int PLATFORM_HEIGHT = 900;

	private Texture texture;

	public ObjectCrane(int x, int y) {
		super();

		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);

		this.type = PLATFORM_TYPE.OBJECT_CRANE;

		this.texture = TextureManager.get("Object_Crane.png");
