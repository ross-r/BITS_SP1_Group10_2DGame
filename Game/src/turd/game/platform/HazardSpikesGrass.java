...
public class HazardSpikesGrass extends Platform {
	...
	public HazardSpikesGrass(int x, int y) { // pass in paramiters 
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.SPIKES_GRASS;
		
		this.texture = TextureManager.get("Hazard_Spikes_Grass.png");
