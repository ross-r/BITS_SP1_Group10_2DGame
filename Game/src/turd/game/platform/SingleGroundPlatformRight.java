...
public class SingleGroundPlatformRight extends Platform {
	...
	public SingleGroundPlatformRight(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_PLATFORM_RIGHT;
		
		this.texture = TextureManager.get("Ground_Platform_Right.png");
