...
public class SingleGroundWallTopLeft extends Platform {
	...
	public SingleGroundWallTopLeft(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_WALL_TOP_LEFT;
		
		this.texture = TextureManager.get("Ground_Wall_Top_Left.png");
