...
public class SingleGroundTopLeft extends Platform {
	...
	public SingleGroundTopLeft(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_TOP_LEFT;
		
		this.texture = new Texture(Graphics.nvgHandle(), "Ground_Top_Left.png");
