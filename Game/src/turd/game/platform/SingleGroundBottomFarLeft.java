...
public class SingleGroundBottomFarLeft extends Platform {
	...
	public SingleGroundBottomFarLeft(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_BOTTOM_FARLEFT;
		
		this.texture = new Texture(Graphics.nvgHandle(), "Ground_Bottom_FarLeft.png");
