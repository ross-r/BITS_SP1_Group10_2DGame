...
public class SingleGroundRoofMidConnectLeft extends Platform {
	...
	public SingleGroundRoofMidConnectLeft(int x, int y) {
		super();

		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);

		this.type = PLATFORM_TYPE.GROUND_ROOF_MID_CONNECT_LEFT;

		this.texture = TextureManager.get("Ground_Roof_Mid_Connect_Left.png");
