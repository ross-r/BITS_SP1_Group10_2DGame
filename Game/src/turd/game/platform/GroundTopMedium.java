...
public class GroundTopMedium extends Platform {
	...
	public GroundTopMedium(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_TOP_MEDIUM;
		
		this.texLeft = new Texture(Graphics.nvgHandle(), "Ground_Top_Mid.png");
		this.texRight = new Texture(Graphics.nvgHandle(), "Ground_Top_Mid.png");
