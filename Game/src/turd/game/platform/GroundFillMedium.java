...
public class GroundFillMedium extends Platform {
	...
	public GroundFillMedium(int x, int y) {
		super();
		
		this.aabb.init(x, y, PLATFORM_WIDTH, PLATFORM_HEIGHT);
		
		this.type = PLATFORM_TYPE.GROUND_FILL_MEDIUM;
		
		this.texLeft = new Texture(Graphics.nvgHandle(), "Ground_Mid_Mid.png");
		this.texRight = new Texture(Graphics.nvgHandle(), "Ground_Mid_Mid.png");
